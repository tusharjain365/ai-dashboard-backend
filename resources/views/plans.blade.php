              ...
              <ul class="mb-6 flex flex-col gap-1.5">
                ...
                <li>
                  <a href="/plans" class="group relative flex items-center gap-2.5 rounded-md
                    ...
                    <svg version="1.1" id="Layer_1" width="20" height="20" xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 128 128" enable-background="new 0 0 128 128" fill="#000000">
            ...
            <div class="bg-white p-4 rounded-md">
              <main>
                ...
                <div class="mx-auto max-w-3xl px-6 lg:px-1">
                  ...
                  <div
                    class="isolate mx-auto m-4 grid max-w-md grid-cols-1 gap-8 md:max-w-2xl md:grid-cols-2 lg:max-w-4xl xl:mx-0 xl:max-w-none xl:grid-cols-2">
                    <!-- Pricing tiers -->
                    <!-- Replace with actual tiers -->
                    <div
                      class="bg-gradient-to-t from-indigo-500 to-indigo-800 text-white rounded-3xl p-4 shadow-md shadow-gray-500/50 cursor-pointer">
                      ...
                      <a href="#" aria-describedby="basic"
                        class="mt-6 block rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 bg-white text-indigo-600 shadow-sm">
                        Buy plan
                      </a>
                      <ul role="list" class="mt-3 space-y-1 text-sm leading-6">
                        <li class="flex gap-x-1">
                          <svg class="h-6 w-5 flex-none" aria-hidden="true" fill="none" stroke="currentColor"
                    ...
                    <div class="text-gray-900 rounded-3xl p-4 shadow-md shadow-gray-500/50 cursor-pointer">
                      ...
                      <a href="#" aria-describedby="premium"
                        class="mt-6 block rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 text-indigo-600 ring-1 ring-inset ring-indigo-200 hover:ring-indigo-300">
                        Buy plan
                      </a>
                      <ul role="list" class="mt-3 space-y-1 text-sm leading-6">
                        <li class="flex gap-x-1">
